...
function generateElectrodeDesignForShape(inputPointList, electrodeSize, electrodeSpacing, rowSpacing, draw){

                
                var rowElectrodes = new Array();
                var columnElectrodes = new Array();
                var inputPolygon = draw.polygon(inputPointList);
                ...
                var polyBBox = generateBoundingBox(inputPointList, draw);
                ...
                rowElectrodes = filterRows(rowElectrodes, columnElectrodes, inputPointList, numRows, numColumns, draw, );
                columnElectrodes = filterColumns(rowElectrodes, columnElectrodes, inputPointList, numRows, numColumns, draw);

                rowElectrodes = checkForDanglingRowElectrodes(rowElectrodes, columnElectrodes, inputPointList, draw);
                columnElectrodes = checkForDanglingColumnElectrodes(rowElectrodes, columnElectrodes, inputPointList, draw);

                filteredRowElectrodes = getActiveElectrodes(rowElectrodes);
                filteredColumnElectrodes = getActiveElectrodes(columnElectrodes); 

                return [rowElectrodes, columnElectrodes];
