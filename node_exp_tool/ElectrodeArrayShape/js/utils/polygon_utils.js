...
function scalePolygon(inputPointList, newPointList, scalingFactor){

    for(var i = 0 ; i < inputPointList.length; i++){
        newPointList[i][0] = inputPointList[i][0] * scalingFactor;
        newPointList[i][1] = inputPointList[i][1] * scalingFactor;
    }
